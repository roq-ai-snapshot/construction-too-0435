...
import { getMaintenanceHistories } from 'apiSdk/maintenance-histories';
...
function DashboardPage() {
  ...
  const maintenanceHistoryStat = useSWR<PaginatedInterface<MaintenanceHistoryInterface>>(
    () => `/maintenance-histories`,
    () => getMaintenanceHistories({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Maintenance Histories',
      result: maintenanceHistoryStat?.data?.totalCount,
      isLoading: maintenanceHistoryStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Logistics',
